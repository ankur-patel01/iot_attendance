...
#define Finger_Rx D3 //D5 14
#define Finger_Tx D4 //D6 12
...
const char *ssid = "oppo a37f";  //ENTER YOUR WIFI SETTINGS
const char *password = "oppooppo";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.43.116/attendance/finger_getdata.php"; //computer IP or the server domain
...
void SendFingerprintID( int finger ){
  ...
  http.begin(Clientt,link); //initiate HTTP request, put your Website URL or Your Computer IP 
