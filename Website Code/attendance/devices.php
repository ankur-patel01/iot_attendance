...
<body style=" background: url('imgg/Campus View of Shri Rawatpura Sarkar Snatak Mahavidyalaya Datia_Campus-View.png') no-repeat center center/cover;
    height: 100vh;">
<?php include'header.php';
?>
<main>
	<h1 class="slideInDown animated">Manage Devices</h1>
